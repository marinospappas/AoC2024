...
val solvers = Map(
    ...
    16 -> ReindeerMinRoute(), 17 -> ByteComputer17(), 18 -> MemoryMaze(), 19 -> StripePatterns(), 20 -> Day0Solver(),
    20 -> Day0Solver(), 21 -> Day0Solver(), 22 -> Day0Solver(), 23 -> Day0Solver(), 24 -> Day0Solver(), 25 -> Day0Solver()
)
...
val results = Map(
    ...
    16 -> ("85420", "492"), 17 -> ("1,2,3,1,3,2,5,3,1", "105706277661082"), 18 -> ("280", "28,56"), 19 -> ("293", "623924810770264"), 20 -> ("0", "0"),
